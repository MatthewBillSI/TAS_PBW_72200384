  ...
  <table class="table table-hover mt-4">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td>
                <a href="/mahasiswa/editmhs/{{$m-> id}}" class="btn btn-outline-warning"><i class="bi bi-pencil-square"></i></a>
                <button type="submit" class="btn btn-outline-danger" onclick="return confirm('yakin untuk menghapus data?')"> 
                  <a href="/mahasiswa/deletemahasiswa/{{$m-> id}}"><i class="bi bi-x-square"></i></a> 
